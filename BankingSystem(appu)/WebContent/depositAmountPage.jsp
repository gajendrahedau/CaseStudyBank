...
<body>
<form name="depositAmountPage" action="depositAmountServlet" method="post">
<div align="center">
<table>
<tr>
...
<td><input type="text" placeholder="Enter amount to be deposited" name="amount" id="amount"  required></td>
</tr>
<tr align="center">
